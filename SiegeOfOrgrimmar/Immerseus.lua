...
local mod, CL = BigWigs:NewBoss("Immerseus", 1136, 852)
...
function mod:Reform()
	blastCounter = 1
	self:MessageOld(143469, "cyan", nil, ("%s (%d%%)"):format(self:SpellName(143469), UnitPower("boss1")))
